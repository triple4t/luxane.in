...
export const getProducts = async (req, res) => {
    try {
        const { category, collection, minPrice, maxPrice, inStock, sortBy = 'featured', search, page = '1', limit = '20', } = req.query;
...
export const uploadProductImages = async (req, res) => {
    try {
        ...
        const uploadPromises = imageFiles.map((file) => uploadToCloudinary(file, 'jewelcraft/products'));
